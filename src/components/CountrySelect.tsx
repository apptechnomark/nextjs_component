...
import styles from "./scss/countrycode.module.scss";
  ...
  return (
    <div className="flex flex-col w-full text-[14px] relative">
      ...
      `}
              ...
              <span className="border-l-[1px] pl-1 py-1 mb-1"></span>
              <input
                className={`${className} pt-0.5 pb-1 outline-none w-full h-full text-darkCharcoal ${err && "text-defaultRed"
                  } `}
                type="tel"
                id={id}
                name={name}
