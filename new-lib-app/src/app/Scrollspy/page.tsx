...
const page: React.FC = () => {
    ...
    return (
        <>
            <div className="scroll-smooth flex flex-row w-full">
                ...
                <div className="flex flex-col w-4/5">
                    <div className="p-4 m-3  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="min-h-[calc(100vh-52px)] top-[100px] ">
                            ...
                            <div
                                id="page-5"
                                className="pt-[40px] min-h-[650px] w-full"
                            >
                        ...
                        >
                            <div className="flex justify-between w-full sticky top-0 bg-[#F4F4F4]">
                                <NavigationBar
                                    ...
                                    variant="modal"
                                />
                                <div onClick={() => setLgOpen(false)} className="p-4">
                                    <Close variant="large" />
                                </div>
                            </div>
                            <div>
                            ...
                            <div className="flex sticky bottom-0 justify-end items-center w-full bg-[#fff] max-[1365px]:h-[76px] min-[1366px]:h-[88px]">
                                <div className="">
                                    <Button className="btn-md rounded-md" variant="btn-outline-primary">
                                        Cancel
                                    </Button>
                                </div>
                                <div className="px-5">
                                    <Button className="btn-md rounded-md" variant="btn-primary">
                                        Save Changes
                                    </Button>
                                </div>
                            </div>
