...
import GenralIcon from './icons/GeneralIcon'
...
const toolTip: React.FC = () => {
    ...
    return <BaseLayout>
        ...
        <div className="p-2  m-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <h2 className="m-5 text-xl  tracking-tight text-gray-900 dark:text-white">Display</h2>
            <div className="flex items-center  flex-col">
                <Tooltip content="General" position="right">
                    <GenralIcon/>
                </Tooltip>
            </div>
        </div>
