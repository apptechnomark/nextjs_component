        ...
        <BaseLayout>
            ...
            <div className="p-2  m-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="pt-3 pl-4 mb-5 gap-8 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                    ...
                    <Avatar name="John Doe" variant="large" />
                </div>
            </div>
            <div className="p-2  m-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <h2 className="m-7 text-xl tracking-tight text-gray-900 dark:text-white">
                ...
                <div className="pt-3 pl-4 mb-5 gap-8 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                    <Avatar name="John Doe" badge variant="small" />
                    <Avatar name="John Doe" badge variant="medium" />
                    <Avatar name="John Doe" badge variant="large" />
                </div>
            </div>
            <div className="p-2  m-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <h2 className="m-7 text-xl tracking-tight text-gray-900 dark:text-white">
                    Basic with Badge Number
                </h2>
                <div className="pt-3 pl-4 mb-5 gap-8 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                    <Avatar name="John Doe" badge variant="small" badgeText="9" />
                    <Avatar name="John Doe" badge badgeText="99" />
                    <Avatar
                        name="John Doe"
                        badge
                        variant="large"
