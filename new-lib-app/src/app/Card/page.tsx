    ...
    <BaseLayout>
      ...
      <div className="p-2  m-3 bg-[#DADADA] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <Card>
          ...
          <CardContent>
            <Image src={Technomark} alt="" width={360} height={170} />
            <CardHeader>
              <div className="ml-2">
                <div className="text-lg font-semibold">
                  Technomark Libraries
                </div>
                <div className="text-gray-500 text-sm">September 14, 2023</div>
              </div>
            </CardHeader>
            <div className="ml-2">
              <span>
                TechnoMark is a team of exceptionally talented people set to
                revolutionize modern-day technology. We are your preferred
                partners for Software, Web, mobile app, and E-commerce
                Development Services.
              </span>
            </div>
          </CardContent>
          <CardAction>
            <Button className="rounded-full mr-2">Enabled</Button>
      ...
      <div className="p-2  m-3 bg-[#DADADA] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <Card>
          <CardHeader>
            ...
            <Image src={Technomark} width={80} height={80} alt="Picture" />
          </CardHeader>
        </Card>
      </div>
